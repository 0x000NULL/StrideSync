...
const MainStack = () => {
  return (
    ...
    >
      ...
      />
      <Stack.Screen name="RunLog" component={RunLogScreen} options={{ title: 'Run Log' }} />
      <Stack.Screen
        name="RunDetails"
      ...
      />
      <Stack.Screen name="AddShoe" component={AddShoeScreen} options={{ title: 'Add New Shoe' }} />
      <Stack.Screen name="EditShoe" component={EditShoeScreen} options={{ title: 'Edit Shoe' }} />
      <Stack.Screen
